...
<body class="bg-color">
  <div class="d-flex text-dark" style="justify-content:center;align-items:center;">
        ...
        <center>
            ...
            <span class="text-dark display-6" style="font-size:large;font-weight:600;">STUDENT LOGIN CREDENTIALS</span><br><br>
            </center>
            ...
            <center><span class="msg"></span></center>
                ...
                <div class="d-flex" style="gap:1rem;align-items:center">
                    <div><button class="btn btn-primary btn-sm rounded p-2" style="border-radius:0px;" id="login-btn">Sign in</button></div>
...
login_btn.addEventListener("click", async () => {
    ...
    const password = document.getElementById("pwd");
        ...
        formData.append('student-login-btn', 1);
