...
<head>
    ...
    <title>Students - Course advisor</title>
...
<div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light d-flex bg-white fixed-top py-3 px-3" style="justify-content:space-between;">
            ...
            <div class="container-fluid px-4 py-4">
                    ...
                    <div class="modal fade modal-lg" id="myModal">
                        ...
                        <div class="modal-body">
                            <form method="post" class="d-flex" onsubmit="return false">
                                ...
                                <button class="btn btn-primary rounded" id="search-btn"><span class="text"><i class="fa fa-search"></i></span></button>
                            </form><br>
                ...
                <!-- END -->
                            <div>
                            <a href="#" class="btn btn-primary rounded mb-4" style="color:#fff;" data-bs-toggle="modal" data-bs-target="#myModal"><small><i class="fa fa-search"></i> Search</small></a>

<?php
             $sql = "SELECT id, fname, lname, school_id, dept, faculty  FROM students_tb WHERE  faculty = '{$faculty}' ORDER BY id DESC";
                            ...
                            <table class="table table-striped table-borderless ">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="viewstudent?id=<?php echo $row['id'];?>" class="btn btn-primary" style="font-size:12px;">  view info </a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
...
search_btn.addEventListener("click", async () => {
    ...
    const searchResult = document.getElementById('searchResult');
        ...
        formData.append('search-students-btn', 1);
