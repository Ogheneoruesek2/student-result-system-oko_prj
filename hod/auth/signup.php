...
<body class="bg-color">
  <div class="d-flex text-dark" style="justify-content:center;align-items:center;">
        ...
        <span class="text-dark display-6" style="font-size:large;font-weight:600;">HOD SIGNUP CREDENTIALS</span><br><br>
            </center>
            ...
            <center><span class="msg"></span></center>
                ...
                <div class=" mb-3 ">
                    <label style="font-weight:600">Faculty</label>
                        <select id="faculty" class="p-2 " style="border-radius: 0px !important;">
                ...
                <button class="btn btn-primary p-2" style="font-size: 12px;"  id="hod_signup_btn">Sign up</button><br><br>
...
/* --- SIGNUP FUNCTION --- */
const sign_up_btn = document.getElementById("hod_signup_btn");
...
const faculty = document.getElementById("faculty");
      ...
      formData.append('hod_signup_btn', 1);
