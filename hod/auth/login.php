...
<head>
    ...
    <title>Result Computation Management System - Login</title>
...
<body class="bg-color">
  <div class="d-flex text-dark" style="justify-content:center;align-items:center;">
        ...
        <center>
            ...
            <span class="text-dark display-6" style="font-size:large;font-weight:600">HOD LOGIN CREDENTIALS</span><br><br>
            </center>
            
            <form method="post" class="bg-white form rounded" style="border-radius: 0px !important;" onsubmit="return false;">
            ...
            <center><span class="msg"></span></center>
                ...
                <div class=" mb-3">
                    ...
                    <input type="password"  id="pwd" class="p-2 rounded pwd">
                </div>
                <div class="d-flex" style="gap:1rem;align-items:center">
                    <div><button class="btn btn-primary btm-sm p-2" style="font-size: 12px;" id="login-btn">Sign in</button></div>
...
login_btn.addEventListener("click", async () => {
    ...
    const password = document.getElementById("pwd");
        ...
        formData.append('hod-login-btn', 1);
