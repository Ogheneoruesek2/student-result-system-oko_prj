        ...
        <div class=" p-4 div-content " id="login-form" >
                        ...
                        <?php if($row['image'] === null) { ?>
                            <div class="passport-photo">
                                <img src="../../uploads/hod/default_img.jpg" alt="hod_image">
                            </div>
                        <?php } else { ?>
                            <div class="passport-photo">
                                <img src="../../uploads/hod/<?php echo $row['image'];?>" width="100%" alt="hod_image">
                            </div>
                        <?php }?>
                        </center>
                        ...
                        <button class="btn btn-primary p-2  mt-4 w-100" style="font-size:12px;" id="update-img-btn" style="font-size:12px;">Update</button><br><br>
                                    ...
                                    <div class="flexbox">
                                        ...
                                        <button class="btn btn-primary p-2  mb-4 " style="font-size:12px;" id="update-btn" style="font-size:12px;">Update</button>
...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        if (response.data.error) {
            msg1.innerHTML = `<div class="alert alert-danger w-100">${response.data.error}</div>`;
        } else if (response.data.success) {
            msg1.innerHTML = `<div class="alert alert-success w-100">${response.data.success}</div>`;
        }
    } catch (error) {
        console.error(error);
        msg1.innerHTML = `<div class="alert alert-danger w-100">An error occurred. Please try again</div>`;
    } finally {
