                ...
                <?php 
                            ...
                            <div class="d-flex" style="justify-content: space-between;">
                                ...
                                <div>
                                    <form method="post" onsubmit="return false;">
                                        <button id="delete-course-btn" class="btn btn-danger p-2" style="border-radius: 0px;"><i class="fa fa-trash"></i></button>
                                    </form>
                                </div>
                            </div><br><br>
                        ...
                        <form class="forms" onsubmit="return false" method="post">
                                                ...
                                                ?>
                                                    ...
                                                    <button class="btn btn-danger" style="font-size:12px;border-radius:0px;" id="drop_course_btn">Drop course</button>
                                                <?php
                                                    } else {
                                                ?>
                                                    <center><span class="msg2"></span></center>
                                                    <input type="hidden" id="course_id2" value="<?php echo $row['id'];?>">
                                                    <button class="btn btn-danger" style="font-size:12px;border-radius:0px;" id="reg_course_btn">Register course</button>
                                                <?php
                                                    }
                                                ?>
