...
<head>
    ...
    <title>Manage Results - Course advisor</title>
...
<div class="d-flex" id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light d-flex bg-white shadow-lg fixed-top py-3 px-3" style="justify-content:space-between;">
               <div class="d-flex">
                ...
                <div class="modal fade modal-lg" id="myModal">
                    ...
                    <div class="modal-body">
                            ...
                            <input type="text" id="search" class="w-100" placeholder="Enter student name or school ID" style="padding: 5px;">
                                ...
                                <button class="btn btn-primary" id="search-btn" style="  border-radius: 0px;"><span class="text"><i class="fa fa-search"></i></span></button>
                            </form><br>
                            <span id="msg"></span>      
                            ...
                            <table class="table table-striped table-borderless">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="viewstudentresult?id=<?php echo $row['id'];?>" class="btn btn-primary" style="font-size:12px;"> Manage result</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
