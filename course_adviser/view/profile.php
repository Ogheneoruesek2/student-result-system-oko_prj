...
<head>
    ...
    <title>Profile - Course Advisor </title>
        ...
        <div class=" p-4 div-content " id="login-form" >
                        ...
                        <?php if($row['image'] === null) { ?>
                            <div class="passport-photo">
                                <img src="../../uploads/course_advisors/default_img.jpg" alt="course_advisor">
                            </div>
                        <?php } else { ?>
                            <div class="passport-photo">
                                <img src="../../uploads/course_advisors/<?php echo $row['image'];?>" width="100%" alt="course_advisor">
                            </div>
                        <?php }?>
                        ...
                        <button class="btn btn-primary p-2  mt-4 w-100" style="font-size:12px;" id="update-img-btn">Update</button><br><br>
                                    ...
                                    <div class="flexbox">
                                        <div class="d-50">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  id="fname" class="w-100 p-2" placeholder="First Name" value="<?php echo $row['fname'];?>">
                                            </div>
                                            <div class="mb-3">
                                            <label style="font-weight:600">Last Name</label>
                                                <input type="text"  id="lname" class="w-100 p-2" placeholder="Last Name" value="<?php echo $row['lname'];?>">
                                            </div>
                                            <div class="mb-3">
                                                <label style="font-weight:600">Email address</label>
                                                <input type="email"  id="email" placeholder="Email Address" class="w-100 p-2" value="<?php echo $row['email'];?>">
                                            </div>
                                        </div>
                                        <div class="d-50">
                                            <div class="mb-3">
                                                <label style="font-weight:600">School ID</label>
                                                <input type="text"  id="school_id" placeholder="School ID" class="w-100 p-2" value="<?php echo $row['school_id'];?>" readonly>
                                            </div>
                                     
                                            <div class="mb-3">
                                                <label style="font-weight:600">Faculty</label>
                                                <input type="email"  id="faculty" placeholder="Faculty" class="w-100 p-2" value="<?php echo $row['faculty'];?>" readonly>
                                            </div>
                                        ...
                                        <button class="btn btn-primary p-2  mb-4 "  id="update-btn" style="font-size: 12px;">Update</button>
...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        if (response.data.error) {
            msg1.innerHTML = `<div class="alert alert-danger">${response.data.error}</div>`;
        } else if (response.data.success) {
            msg1.innerHTML = `<div class="alert alert-success">${response.data.success}</div>`;
        }
    } catch (error) {
        console.error(error);
        msg1.innerHTML = `<div class="alert alert-danger">An error occurred. Please try again</div>`;
    } finally {
